      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-gray-600 text-lg leading-loose">
            We aim to simplify the rental process by providing a seamless
            experience through transparent listings, direct communication, and
            secure transactions. Our mission is to empower tenants and landlords
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-xl transition">
              ...
              <p className="text-gray-600">
                Browse through a wide range of available rental properties with
                filters that match your needs.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-xl transition">
              <h3 className="text-xl font-semibold mb-3 text-gray-800">
              ...
              <p className="text-gray-600">
                Message property owners directly. No middlemen. No confusion.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-xl transition">
              <h3 className="text-xl font-semibold mb-3 text-gray-800">
              ...
              <p className="text-gray-600">
                Choose properties, pay securely, and start living. We make
                renting simple.
              </p>
            </div>
          </div>
