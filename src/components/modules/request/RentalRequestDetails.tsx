...
const RentalRequestDetails: React.FC<RentalRequestPageProps> = ({
  listing,
  requestData,
}) => {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="text-sm font-se text-gray-800 text-center my-3">
        Landlord Review Your Request, <br />
        If Approved Your Request, You direct contact landlord Phone no and
      ...
      <div className="">
        ...
        <div className="bg-white  flex flex-col md:flex-row  items-center justify-center gap-4 p-6 rounded-lg shadow-md">
          <div className="w-1/2">
            ...
            <h2 className="text-md text-gray-700 font-medium mb-4">
              {listing?.location}
            </h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <div className="flex justify-between items-center border-t border-b py-3 my-5">
                  <Image
                    ...
                    width={100}
                    height={75}
                    alt="Houswe Solution Logo"
                  />
                  <p className="text-gray-600 font-bold text-xl">
                    Request Message For Rent
                  </p>
                </div>
