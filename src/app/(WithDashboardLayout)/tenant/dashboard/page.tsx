    ...
    <main className="flex-1 p-6">
      ...
      <section className="bg-white rounded-xl shadow p-6 mb-8">
        ...
        <div className="space-y-2 text-gray-600">
          <p>
            <strong>Property:</strong> {activeRental.title}
          </p>
          <p>
            <strong>Address:</strong> {activeRental.address}
          </p>
          <p>
            <strong>Status:</strong>{' '}
            <span className="text-green-600">{activeRental.status}</span>
          </p>
          <p>
            <strong>Rent:</strong> {activeRental.rent}
          </p>
        </div>
      </section>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-800 text-white p-6 rounded-xl shadow-md flex flex-col md:flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm text-white/80">
              Explore new listings in your area now!
            </p>
          </div>
          <a
            href="#"
