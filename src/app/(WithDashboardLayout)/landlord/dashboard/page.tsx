  ...
  return (
    <main className="flex-1 p-6">
        <header className="mb-6">
          <h1 className="text-3xl font-bold text-gray-800">Welcome Back, Landlord!</h1>
          <p className="text-gray-500">Manage your properties and view tenant requests.</p>
        </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {listings.map((listing, idx) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500">Requests: {listing.requests}</p>
        ...
        <section className="mt-10">
          <div className="bg-gradient-to-r from-green-500 to-green-900 text-white p-6 rounded-xl shadow-md flex flex-col md:flex-row items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/80">List your new apartment, house, or studio now!</p>
            </div>
            <a
              href="#"
